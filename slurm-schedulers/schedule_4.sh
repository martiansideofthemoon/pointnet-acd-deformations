#!/bin/sh
#SBATCH --job-name=finetune_acd_4
#SBATCH -o logs/log_4.txt
...
# Run Details :- cpus = 3, gpu = rtx8000, memory = 45, ngpus = 1, perturb_amount = 0.0, perturb_types = drop,scale,rotate, valid_shape_loss_lmbda = 0.0
