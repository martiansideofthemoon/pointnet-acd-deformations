#!/bin/sh
#SBATCH --job-name=train_seg_acd_14
#SBATCH -o logs/log_14.txt
...
# Run Details :- cpus = 3, downstream_type = fewshotseg, gpu = 1080ti, memory = 45, ngpus = 1, perturb_amount = 0.5, perturb_types = rotate, self_sup_lmbda = 0.0, valid_shape_loss_lmbda = 1.0
...
python train_partseg_shapenet_multigpu.py \
    --seed 2001 \
    --k_shot 5 --batch_size 32 --selfsup --step_size 1  --epoch 9 \
    --ss_path data/ACDv2/ \
