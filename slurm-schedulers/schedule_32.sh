#!/bin/sh
#SBATCH --job-name=finetune_acd_32
#SBATCH -o logs/log_32.txt
...
# Run Details :- cpus = 3, downstream_type = modelnet40, gpu = 1080ti, memory = 45, ngpus = 1, perturb_amount = 0.5, perturb_types = drop,scale,rotate, self_sup_lmbda = 1.0, valid_shape_loss_lmbda = 10.0
