#!/bin/sh
#SBATCH --job-name=finetune_acd_2
#SBATCH -o logs/log_2.txt
...
# Run Details :- cpus = 3, gpu = rtx8000, memory = 45, ngpus = 1, perturb_amount = 0.5, perturb_types = drop,scale,rotate, valid_shape_loss_lmbda = 1.0
