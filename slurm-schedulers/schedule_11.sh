#!/bin/sh
#SBATCH --job-name=train_seg_acd_11
#SBATCH -o logs/log_11.txt
...
# Run Details :- cpus = 3, downstream_type = fewshotseg, gpu = 1080ti, memory = 45, ngpus = 1, perturb_amount = 0.5, perturb_types = drop,scale,rotate, valid_shape_loss_lmbda = 0.0
